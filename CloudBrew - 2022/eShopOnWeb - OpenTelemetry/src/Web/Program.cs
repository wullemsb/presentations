...
var serviceName = "CloudBrew.eShop.Web";
...
builder.Services.AddOpenTelemetryTracing(tracerProviderBuilder =>
{
    tracerProviderBuilder
        ...
        {
            o.ConnectionString =
                "InstrumentationKey=a66a4cb1-3262-4549-8921-853f5f174bad;IngestionEndpoint=https://westeurope-5.in.applicationinsights.azure.com/;LiveEndpoint=https://westeurope.livediagnostics.monitor.azure.com/";
        })
        .AddConsoleExporter()
